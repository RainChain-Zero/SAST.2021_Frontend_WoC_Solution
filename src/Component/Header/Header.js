...
class Header extends Component {
    ...
    locationOnChange = (value) => {
        if (typeof (value) !== "undefined") {
            ...
            if (value.length === 3)
                this.location = value[value.length - 2] + value[value.length - 1]
            else
                this.location = value
        }
    }
